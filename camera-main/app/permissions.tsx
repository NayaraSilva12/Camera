...
import { Alert, StyleSheet, TouchableHighlight, View, Switch } from 'react-native'
    ...
    <Stack.Screen options={{headerTitle: "Permissions"}}/>
        ...
        <View style={styles.spacer}/>
            <ThemedText type='subtitle' style={styles.subtitle}>
                Aplicativo de Câmera precisa acessar algumas permissões
                para funcionar corretamente em seu dispositivo.
            </ThemedText>
